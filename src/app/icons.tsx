...
export const BudgetIcon = ({ size }: { size?: number }): React.JSX.Element => (
  <I {...(size !== undefined ? { size } : {})}>
...
export const SettingsIcon = ({ size }: { size?: number }): React.JSX.Element => (
  <I {...(size !== undefined ? { size } : {})}>
...
export const PauseIcon = ({ size }: { size?: number }): React.JSX.Element => (
  <I {...(size !== undefined ? { size } : {})}>
...
export const HelpIcon = ({ size }: { size?: number }): React.JSX.Element => (
  <I {...(size !== undefined ? { size } : {})}>
    <circle cx="12" cy="12" r="9" />
    <path d="M9.5 9.2a2.6 2.6 0 015 1.1c0 1.6-2.5 2-2.5 3.7" />
